...
const previewModal = document.querySelector("#new-post-preview-modal");
...
function getCardElement(data) {
  ...
  cardLikeBtnEl.addEventListener("click", (evt) => handleLike(evt, data._id, data));
...
function handleLike(evt, id, data) {
